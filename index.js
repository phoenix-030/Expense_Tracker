...
// Function to generate random but consistent colors per category
...
function updateChart() {
  ...
  expenseChart.data.datasets[0].backgroundColor = Object.keys(categoryTotals).map(getCategoryColor);
